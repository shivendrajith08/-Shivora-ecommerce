      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center h-16 gap-3">
          ...
          <div className="flex items-center gap-1 lg:hidden flex-shrink-0">
            ...
            {/* Wishlist */}
            <Link to="/wishlist" className="relative min-w-[44px] min-h-[44px] hidden md:flex items-center justify-center text-silver-dim hover:text-parchment transition-colors">
