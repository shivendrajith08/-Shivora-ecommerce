        ...
        <div className="flex items-center h-16 gap-3">
          ...
          <div className="flex items-center gap-1 lg:hidden flex-shrink-0">
            ...
            <Link to="/cart" aria-label="Cart"
              className="relative min-w-[44px] min-h-[44px] flex items-center justify-center text-silver-muted hover:text-gold transition-colors">
              <IconCart />
              {cartCount > 0 && (
            ...
            {/* Profile */}
            {isAuthenticated && (
              <Link to="/profile" className="min-w-[44px] min-h-[44px] flex items-center justify-center text-silver-dim hover:text-parchment transition-colors lg:hidden">
                {user?.profile_image ? (
