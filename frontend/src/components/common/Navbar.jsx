          ...
          <nav className="hidden lg:flex items-center gap-5 flex-shrink-0">
            ...
            {isAuthenticated && (
              <Link to="/wishlist" title="Wishlist"
                className="text-silver-muted hover:text-[#F59E0B] transition-colors">
            ...
            <Link to="/cart" title="Cart"
              ...
              {cartCount > 0 && (
                <span className="absolute -top-2 -right-2 bg-[#F59E0B] text-[#020818] text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center">
              ...
              <div className="relative">
                <button onClick={() => setUserMenuOpen(v => !v)}
                  ...
                  {avatarUrl ? (
                    ...
                    <div className="w-8 h-8 rounded-full bg-surface-raised border border-[#F59E0B]/40 text-[#F59E0B] flex items-center justify-center font-bold text-sm">
                      {initials}
                    </div>
                  )}
                </button>
          ...
          <div className="flex items-center gap-1 lg:hidden flex-shrink-0">
            ...
            {isAuthenticated && (
              <Link to="/profile" className="min-w-[44px] min-h-[44px] flex items-center justify-center">
                {avatarUrl ? (
                  <img src={avatarUrl} alt="avatar" className="w-8 h-8 rounded-full object-cover flex-shrink-0 border border-[#F59E0B]/40" />
                ) : (
                  <div className="w-8 h-8 rounded-full bg-[#F59E0B] text-[#020818] text-xs font-bold flex items-center justify-center flex-shrink-0">
                    {initials}
                  </div>
                )}
              </Link>
            ...
            <Link to="/cart" aria-label="Cart"
              className="relative min-w-[44px] min-h-[44px] hidden md:flex items-center justify-center text-silver-muted hover:text-[#F59E0B] transition-colors">
              <IconCart />
              {cartCount > 0 && (
                <span className="absolute top-1 right-0.5 bg-[#F59E0B] text-[#020818] text-[10px] font-bold w-4 h-4 rounded-full flex items-center justify-center leading-none">
                  {cartCount > 99 ? '99+' : cartCount}
                </span>
              )}
            </Link>
            ...
            <button
              ...
              className="min-w-[44px] min-h-[44px] flex items-center justify-center text-silver-muted hover:text-[#F59E0B] transition-colors"
                ...
                {isAuthenticated ? (
                  ...
                  <>
                    ...
                    <Link to="/login" onClick={closeMenu}
                      className="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-[#F59E0B] hover:bg-[#F59E0B]/10 rounded-lg transition-colors">
            ...
            {isAuthenticated && (
              <div className="flex-shrink-0 px-4 py-3 border-t border-surface-border bg-surface-raised">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-surface border border-[#F59E0B]/40 text-[#F59E0B] flex items-center justify-center font-bold text-sm flex-shrink-0">
                    {initials}
                  </div>
