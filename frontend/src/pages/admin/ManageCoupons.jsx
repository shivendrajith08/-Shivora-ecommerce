              ...
              <tbody>
                {coupons.map((c) => (
                  <tr key={c.id} className="border-t border-surface-border hover:bg-surface-raised/50 transition-colors">
                    <td className="px-4 py-3 font-bold text-gold">{c.code}</td>
                    ...
                    <td className="px-4 py-3">
                      <button
                        ...
                        className={`text-xs font-bold px-2.5 py-1 rounded-full transition ${
                          c.active ? 'bg-gold/10 text-gold border border-gold/30' : 'bg-surface-raised text-silver-dim border border-surface-border'
                        }`}
                        title="Toggle active"
                      >
