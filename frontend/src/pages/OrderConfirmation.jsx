...
const SuccessCheck = () => (
  <>
    ...
    `}</style>
    <div
      className="w-20 h-20 rounded-full border-4 border-[#F59E0B] flex items-center justify-center bg-[#F59E0B]/5"
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="flex flex-col items-center text-center mb-8">
        <SuccessCheck />
        <h1 className="text-3xl font-bold text-[#F59E0B] mt-5 mb-2">Order Confirmed!</h1>
