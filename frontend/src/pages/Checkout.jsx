  ...
  return (
    <div className="max-w-[1440px] mx-auto px-4 sm:px-6 py-8 pb-40 lg:pb-8">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        {buyNow && (
          <span className="inline-flex items-center gap-1 bg-[#F59E0B]/15 text-[#F59E0B] border border-[#F59E0B]/30 text-xs font-extrabold px-2.5 py-1 rounded-full uppercase tracking-widest">
      ...
      <div className="grid lg:grid-cols-[1fr_340px] gap-6 relative">
        <form id="checkout-form" onSubmit={handleSubmit} className="card p-4 sm:p-6 space-y-4">
          ...
          {mode === 'picker' ? (
            <>
              <h3 className="font-bold text-[#F59E0B] mb-2">Deliver to</h3>
                    ...
                    <button
                      ...
                      className={`w-full text-left rounded-lg border p-4 transition-colors ${
                        selected
                          ...
                          : 'border-surface-border bg-surface hover:border-[#F59E0B]/50'
                      }`}
                    >
                      <div className="flex items-start gap-3">
                        {/* radio dot */}
                        <span className={`mt-0.5 w-4 h-4 rounded-full border flex items-center justify-center flex-shrink-0 ${
                          selected ? 'border-[#F59E0B]' : 'border-silver-dim'
                        }`}>
                          {selected && <span className="w-2 h-2 rounded-full bg-[#F59E0B]" />}
                        </span>
          ...
          <div className="pt-2 border-t border-surface-border">
            {!appliedCoupon && !couponOpen && (
              <button
                ...
                className="flex items-center gap-2 text-sm font-semibold text-[#F59E0B] hover:underline"
              >
          ...
          <div className="pt-2">
            ...
            <div className="flex items-center gap-2 border border-surface-border rounded-lg px-4 py-3 bg-surface-raised">
              <input type="radio" checked readOnly style={{ accentColor: '#F59E0B' }} />
