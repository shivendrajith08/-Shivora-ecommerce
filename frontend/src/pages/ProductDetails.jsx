  ...
  return (
    <div className="max-w-[1440px] mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="grid md:grid-cols-2 gap-10">
        <div className="aspect-square bg-surface-raised rounded-xl overflow-hidden border border-surface-border">
          {imageSrc ? (
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3">
            ...
            <button onClick={handleAddToWishlist} disabled={wishing} className="btn-secondary !px-6 !py-3 sm:w-auto">
